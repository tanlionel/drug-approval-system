...
@Service
public class ThymeleafServiceImplement implements ThymeleafService {
    ...
    private static TemplateEngine emailTemplateEngine() {
        ...
        templateEngine.setTemplateResolver(htmlTemplatorResolver());
        return templateEngine;
    }

    private static ITemplateResolver htmlTemplatorResolver() {
